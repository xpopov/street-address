...
class AddressTest < Minitest::Test
  ...
  INFORMAL_ADDRESSES = {
    "#42 233 S Wacker Dr 60606" => {
      ...
      line2: "60606",
      line1_without_unit: "233 S Wacker Dr"
    },
    ...
    "2730 S Veitch St #207" => {
      line1: "2730 S Veitch St # 207",
      line2: "",
      line1_without_unit: "2730 S Veitch St"
    },
    "321 S. Washington" => {
      line1: "321 S Washington",
      line2: "",
      line1_without_unit: "321 S Washington"
    },
  ...
  def test_line1_without_unit_with_informal_addresses
    INFORMAL_ADDRESSES.each_pair do |address, expected|
      addr = StreetAddress::US.parse_informal_address(address)
      assert_equal addr.line1_without_unit, expected[:line1_without_unit]
    end
  end
